...
export default function BackgroundEffects() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10 bg-[#070514]">
      ...
      {/* Floating glowing orbs with GPU acceleration */}
      <motion.div
        animate={{
          x: [0, 40, 0],
          y: [0, -25, 0],
        ...
        className="absolute top-[20%] left-[15%] w-64 h-64 sm:w-96 sm:h-96 bg-purple-600/20 rounded-full blur-[90px] will-change-transform transform-gpu"
      />
      <motion.div
        animate={{
          x: [0, -35, 0],
        ...
        className="absolute bottom-[20%] right-[10%] w-72 h-72 sm:w-110 sm:h-110 bg-fuchsia-700/15 rounded-full blur-[100px] will-change-transform transform-gpu"
      />
      ...
      {particles.map((particle) => (
        <motion.div
          key={particle.id}
          className="absolute rounded-full bg-purple-300 shadow-[0_0_6px_rgba(216,180,254,0.7)] will-change-transform transform-gpu"
          style={{
            width: particle.size,
