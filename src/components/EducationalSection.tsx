...
const MarketingRoadmap = dynamic(() => import("./educational/MarketingRoadmap"), {
...
const CybersecurityRoadmap = dynamic(() => import("./educational/CybersecurityRoadmap"), {
  loading: () => <RoadmapSkeleton title="Ciberseguridad & Hacking Ético" />,
});

const FullStackRoadmap = dynamic(() => import("./educational/FullStackRoadmap"), {
  loading: () => <RoadmapSkeleton title="Full Stack & Ingeniería en Sistemas" />,
});

const BusinessManagementRoadmap = dynamic(() => import("./educational/BusinessManagementRoadmap"), {
  loading: () => <RoadmapSkeleton title="Administración Empresarial & Marco Legal" />,
});

const MedicineRoadmap = dynamic(() => import("./educational/MedicineRoadmap"), {
  loading: () => <RoadmapSkeleton title="Medicina" />,
});

const CriticalThinkingRoadmap = dynamic(() => import("./educational/CriticalThinkingRoadmap"), {
  loading: () => <RoadmapSkeleton title="Pensamiento Crítico & Sistemático" />,
});

const PublicSpeakingRoadmap = dynamic(() => import("./educational/PublicSpeakingRoadmap"), {
...
export default function EducationalSection() {
  ...
  const topics = useMemo(() => [
    ...
    },
    {
      ...
      category: "academia",
      keywords: "diseño planos autocad sketchup construccion estructuras espacio",
      icon: Landmark,
    },
    {
    ...
    },
    {
      ...
      category: "academia",
      keywords: "simulacro matematicas lectura critica ciencias naturales ingles cuadernillos preguntas",
      icon: Award,
    },
    {
      ...
      category: "tecnologia",
      keywords: "seguridad informatica linux redes hacking etico proteccion datos",
      icon: Shield,
    },
    {
      ...
      category: "tecnologia",
      keywords: "programacion software web frontend backend react javascript python bases datos",
      icon: Code2,
    },
    {
    ...
    },
    {
      ...
      label: "🩺 Medicina",
      category: "salud",
      keywords: "anatomia salud primeros auxilios fisiologia cuerpo humano bienestar",
      icon: HeartPulse,
    },
    {
    ...
    },
    {
      ...
      category: "academia",
      keywords: "hablar en publico voz expresion carisma discursos presentaciones",
      icon: Mic,
    },
    {
